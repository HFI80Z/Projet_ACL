...
# Spécifier la période d'inactivité en jours
PERIODE_INACTIVITE=90

# Obtenir la liste des utilisateurs inactifs depuis 90 jours en utilisant lastlog
...
# Vérifier si des utilisateurs inactifs sont trouvés
